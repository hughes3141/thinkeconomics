...
function getMCQquestionDetails2($id = null, $questionNo = null, $topic = null, $keyword = null, $search = null, $orderBy = null, $examBoard = null, $year = null, $component = null, $unitName = null) {
  ...
  */
  ...
  $sql ="SELECT q.id, q.No, q.Answer, q.Topic, q.topics, q.keywords, q.question, q.question2, q.options, q.explanation, q.examBoard, q.component, q.assetId, q.unitName, q.qualLevel, q.textOnly, q.topicsAQA, q.topicsEdexcel, q.topicsOCR, q.topicsCIE, q.series, q.year, q.questionNo, q.noRandom, q.similar, q.relevant, a.path
        FROM question_bank_3 q
        LEFT JOIN upload_record a
          ON a.id = q.assetId";
...
function updateMCQquestion($id, $userId, $explanation, $question, $optionsJSON, $topic, $topics, $answer, $keywords, $textOnly, $relevant, $similar, $noRandom, $question2) {
  /*
  ...
  */
  ...
  $sql = "UPDATE question_bank_3
          SET question = ?, options = ?, Topic = ?, topics = ?, Answer = ?, keywords = ?, textOnly = ?, relevant = ?, similar = ?, similar_array = ?, noRandom = ?, question2 = ?
          WHERE id = ?";
  $stmt=$conn->prepare($sql);
  $stmt->bind_param("ssssssiissisi", $question, $optionsJSON, $topic, $topics, $answer, $keywords, $textOnly, $relevant, $similar, $similar_array, $noRandom, $question2, $id);
  $stmt->execute();
