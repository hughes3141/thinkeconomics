...
<p>Name: <input type = "text" name ="name" id = "name" style="" ></p>
...
var index = [
[50,50,1, 2,3,.1, -.5,.5,.05, -.5, .5,.05],
[200, 250, 10, 60, 70, 1, -.5,.5,.05, -.5,.5,.05],
[50,70,5, 80,90,1, -.5,.5,.05, -.5,.5,.05],
[100,160,10, 60,70,1, -.5,.5,.05, -.5,.5,.05],
...
*/
	...
	p3.innerHTML = 'What is the PED of this product? <input type="number" id ="'+question_no+'_0" class="question_'+question_no+' ex1">';
	var p4 = document.createElement("p");
	p4.innerHTML = 'What was the revenue for this product before the price change? <input type="number" id ="'+question_no+'_1" class="question_'+question_no+' ex1">';
	var p5 = document.createElement("p");
	p5.innerHTML = 'What is the revenue for this product after the price change? <input type="number" id ="'+question_no+'_2" class="question_'+question_no+' ex1">';
...
*/
	...
	var p3 = document.createElement("p");
	p3.innerHTML = 'What is the PED of this product? <input type="number" id ="'+question_no+' " class="question_'+question_no+' ex2">';
...
*/
	...
	var p4 = document.createElement("p");
	p4.innerHTML = 'What is the new Quantity following the price change? <input type="number" id ="'+question_no+'" class="question_'+question_no+' ex3">';
	/*var p5 = document.createElement("p");
...
*/
	...
	p3.innerHTML = 'PED: '+pedCoeff[0];
	var p4 = document.createElement("p");
	p4.innerHTML = 'What is the new Revenue following the price change? <input type="number" id ="'+question_no+'" class="question_'+question_no+' ex4">';
	/*var p5 = document.createElement("p");
	p5.innerHTML = 'What is the revenue for this product after the price change? <input type="number" id ="'+question_no+'_2">';
	var p6 = document.createElement("p");
	p6.innerHTML = 'This product is:<br><input type="radio" id="elastic_'+question_no+'" name="elasticity" ><label for="elastic_'+question_no+'">Elastic</label><br><input type="radio" id="inelastic_'+question_no+'" name="elasticity" ><label for="inelastic_'+question_no+'">Inelastic</label>';
