...
// HERE IS WHERE TO CHANGE FEEDBACK TO REFLECT QUESTIONS
					...
					if ($x == 0) {
						...
						/*
						echo "Explanation:";
						echo "<div id = 'answer_feedback_".$x."'>answer_feedback_".$x."</div>";
						*/
					}
					...
					if ($x == 1) {
						echo "Your answer: ".$response1;
						echo "<br>";
						echo "Correct answer: &pound;".number_format($revenue2);
						echo "<br>";
						/*
						echo "Explanation:";
						echo "<div id = 'answer_feedback_".$x."'>answer_feedback_".$x."</div>";
...
echo "<button type= 'button' onclick = 'submitForm()'>Submit</button>";
//type='submit'
...
for(var i=0; i<questionIndex.length; i++) {
	...
	echo "
	document.getElementById('answer_feedback_'+i).innerHTML = answerIndex[i];
