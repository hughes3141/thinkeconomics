...
<div class="container mx-auto px-4 mt-20 lg:mt-32 xl:mt-20 lg:w-3/4">
  ...
  <div class="container mx-auto px-0 mt-2 bg-white text-black ">
    <div class="grid md:grid-cols-2 gap-4">    <?php 
      foreach($randomQuestions as $key=>$question) {
        ?>
        
        <div class="content-center">
          <div class=" question text-center m-3 py-2 px-4 bg-pink-400 text-white font-semibold rounded-lg shadow-md hover:bg-sky-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75" onclick="showAnswers(<?=$key;?>)">
...
<script>
  ...
  console.log("$GET Variables: topic, topics, number:number of questions =10")
