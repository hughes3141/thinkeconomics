...
<div class="container mx-auto px-4 mt-20 lg:mt-32 xl:mt-20 lg:w-3/4">
    <h1 class="font-mono text-2xl bg-pink-400 pl-1">MCQ Questions - New Entry</h1>
    <div class=" container mx-auto p-4 mt-2 bg-white text-black mb-5">
      ...
      <p class="mb-3"><a class="underline text-sky-700 hover:bg-sky-100" href="mcq_questions.php">&larr; Back to review questions</a></p>
